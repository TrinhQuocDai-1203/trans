...
<head>
    ...
    <title>FUTA Bus Lines - Quản lý xe</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10" style="padding-left: 0px !important; padding-right: 0px !important;">
                <div class="admin-header py-3">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1 class="admin-title">Quản lý xe</h1>
                ...
                <div style="padding: 0px 20px;">
                    ...
                    <div class="col-md-8">
                        <form action="${pageContext.request.contextPath}/admin/buses/search" method="get" class="d-flex">
                            <input type="text" name="licensePlate" class="form-control me-2 search-input" style="width: 50%;" placeholder="Tìm kiếm theo biển kiểm soát" 
                    ...
                    <a href="${pageContext.request.contextPath}/admin/buses/add" class="btn action-btn">
                ...
                <div class="table-container">
                    <h2 class="section-title"><i class="bi bi-truck"></i> Danh sách xe</h2>
                                ...
                                <c:forEach var="bus" items="${buses}">
                                    <tr>
                                        ...
                                        <td class="action-column">
                                            <a href="${pageContext.request.contextPath}/admin/buses/edit/${bus.id}" class="btn btn-sm btn-outline-primary">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/admin/buses/delete/${bus.id}" 
